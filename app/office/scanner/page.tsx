      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>Scanner</h1>
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Scan documents with your camera</p>
          </div>
          <button
        ...
        {scannedDocuments.length === 0 ? (
          <div className="glass-card p-12 text-center">
            <Camera className="w-16 h-16 mx-auto mb-4" strokeWidth={1} style={{ color: 'var(--text-muted)' }} />
            <p className="mb-2" style={{ color: 'var(--text-secondary)' }}>No scanned documents yet</p>
            <p className="text-sm mb-6" style={{ color: 'var(--text-muted)' }}>Scan your first document to get started</p>
            <button
              onClick={() => setShowUpload(true)}
